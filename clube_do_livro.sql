...
#Todos os livros com 10% de desconto
UPDATE LIVROS SET PRECO = 0.9*PRECO;

#Tabela com nomes dos vendedores e o histórico de pedidos
...
#Para Júlia identificar o nome dos livros que foram vendidos na tabela VENDAS há 3 formas:
#1
...
#Para saber a maior venda feita no Clube do Livro
...
#"Será que todos os livros da nossa base foram vendidos?" - LEFT JOIN
SELECT LIVROS.NOME_LIVRO, 
       VENDAS.QTD_VENDIDA
...
#"Será que todos os livros da nossa base foram vendidos?" - RIGHT JOIN 
